                    ...
                    <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-8 space-y-6">
                        ...
                        <div className="pt-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div className={`${stock[0] ? "" : "hidden"} bg-gradient-to-br from-green-50 to-white p-5 rounded-xl border-2 border-gray-200 hover:border-[#4CAF50] transition-all duration-300 shadow-sm hover:shadow-md`}>
...
`}
                                ...
                                <div className={`${stock[1] ? "" : "hidden"} bg-gradient-to-br from-green-50 to-white p-5 rounded-xl border-2 border-gray-200 hover:border-[#4CAF50] transition-all duration-300 shadow-sm hover:shadow-md`}>
                                    <label className="flex flex-col space-y-3">
                                        <span className="text-base font-semibold text-[#2d5016]">
                                            70L Vreča
                                        </span>
                                ...
                                <div className={`${stock[2] ? "" : "hidden"} bg-gradient-to-br from-green-50 to-white p-5 rounded-xl border-2 border-gray-200 hover:border-[#4CAF50] transition-all duration-300 shadow-sm hover:shadow-md`}>
                                    <label className="flex flex-col space-y-3">
                                        <span className="text-base font-semibold text-[#2d5016]">
                                            BigBag
                                        </span>
