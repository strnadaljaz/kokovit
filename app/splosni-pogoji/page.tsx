...
<ul className="list-disc ml-6 mb-2">
  ...
  <li>ali potrdi na drug dogovorjen način</li>
</ul>
...
Reklamacijo je potrebno poslati pisno na e-poštni naslov: kokovit.info@gmail.com, skupaj z opisom težave in fotografijami (če je možno).</p>
                <h2 className="text-xl md:text-2xl font-semibold text-[#2d5016] mt-6 mb-3">10. Varovanje osebnih podatkov</h2>
                <p className="mb-4">Ponudnik se zavezuje k varovanju osebnih podatkov uporabnikov v skladu z GDPR in ZVOP-2.<br />
Osebni podatki se uporabljajo izključno za:</p>
<ul className="list-disc ml-6 mb-2">
  <li>obdelavo naročil</li>
  <li>komunikacijo s stranko</li>
  <li>obveščanje o dostavi</li>
</ul>
<p className="mb-4">Več informacij je na voljo v <a href="/politika-zasebnosti" className="underline">Politiki zasebnosti.</a></p>
                <h2 className="text-xl md:text-2xl font-semibold text-[#2d5016] mt-6 mb-3">11. Omejitev odgovornosti</h2>
                <p className="mb-4">Ponudnik ne odgovarja za:</p>
<ul className="list-disc ml-6 mb-2">
  <li>morebitne tipkarske napake</li>
  <li>motnje v delovanju spletne strani</li>
  <li>nepravilno uporabo izdelkov ali neupoštevanje navodil</li>
</ul>
                <h2 className="text-xl md:text-2xl font-semibold text-[#2d5016] mt-6 mb-3">12. Spremembe splošnih pogojev</h2>
                <p className="mb-4">Ponudnik si pridržuje pravico do spremembe splošnih pogojev brez predhodnega obvestila. Veljajo pogoji, objavljeni ob oddaji naročila.</p>
                <h2 className="text-xl md:text-2xl font-semibold text-[#2d5016] mt-6 mb-3">13. Reševanje sporov</h2>
                <p className="mb-4">Za vse spore je pristojno sodišče v Republiki Sloveniji.<br />
Ponudnik ne priznava nobenega izvajalca izvensodnega reševanja potrošniških sporov kot obveznega.</p>
