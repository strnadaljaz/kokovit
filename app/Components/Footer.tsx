            ...
            <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        <li><a href="#Domov" className="hover:opacity-70 transition-opacity">Domov</a></li>
                        <li><a href="#Produkti" className="hover:opacity-70 transition-opacity">Produkti</a></li>
                        <li><a href="#O nas" className="hover:opacity-70 transition-opacity">O nas</a></li>
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                        <li className="flex items-center gap-2">
                            ...
                            <a href="tel:+386123456789" className="hover:opacity-70 transition-opacity">+386 12 345 6789</a>
                        </li>
                        <li className="flex items-center gap-2">
                            <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                            </svg>
                            <a href="mailto:info@kokovit.si" className="hover:opacity-70 transition-opacity">info@kokovit.si</a>
                        </li>
                    </ul>
                </div>
            </div>
